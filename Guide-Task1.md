# FlyEnv PHP常见项目部署方式 Guide文档生成任务
...
目前FlyEnv已经把常见的PHP 生态几个比较热门的运行方案基本补齐了：
...
需要你帮我写一个中英文指南。 内容是： PHP常见项目的部署方式，在FlyEnv里要如何部署，以及和其他模块的联动。

这些模块可以在FlyEnv项目里查看。 FlyEnv项目文件夹： E:\Github\FlyEnv

先整理一个指南准备涉及的PHP常见项目。发出来我确认下。 确认后再继续写指南