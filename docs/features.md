...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Kimi', detail: 'Connect Kimi to local development workflows.', href: '/features/kimi', logo: kimiLogo },
      { name: 'Antigravity CLI', detail: 'Use Antigravity CLI with FlyEnv context.', href: '/features/antigravity-cli', logo: antigravityLogo },
      { name: 'GitHub Copilot CLI', detail: 'Bring Copilot CLI into your terminal workflow.', href: '/features/github-copilot-cli', logo: githubLogo },
      { name: 'Hermes Agent', detail: 'Connect an AI agent to local services.', href: '/features/hermes-agent', logo: hermesLogo },
      { name: 'OpenClaw', detail: 'Build local agent workflows with OpenClaw.', href: '/features/openclaw', logo: openClawLogo },
