...
| rust | Local Rust Development with FlyEnv | Rust Toolchain Manager for Local Development | Install Rust toolchains, switch the active cargo/rustc with rustup or PATH, and run Rust projects locally. | 3 | Version management (rustup); Command-line switching; Projects; Compatibility Notes | rustup, Version Manager, PATH, Projects | /guide/project-level-runtime-environment, /download |
