<template>
  <div class="sponsor-page">
    ...
    <section class="sponsor-hero-section">
      <div class="sponsor-hero-inner">
        ...
        <p class="sponsor-hero-desc">
          FlyEnv is an independently built, open-source environment manager for macOS, Windows, and
          Linux. Your support keeps it free and constantly improving.
        </p>
      </div>
    </section>
        ...
        <div class="manifesto-card">
          ...
          <div class="manifesto-content">
            ...
            <p class="manifesto-text"
              >FlyEnv is independently built and maintained by a single developer.</p
            >
            ...
            <p class="manifesto-text"
              >Just continuous work to make local development better for everyone.</p
            >
      ...
      <div class="sponsor-section-inner-wide">
        ...
        <div class="support-grid">
          ...
          <div class="support-card card-hover wide">
            ...
            <p
              >No ads, no tracking, no paywalls — just a tool built for developers, funded by
              developers.</p
            >
          </div>
        </div>
    ...
    <!-- Donation Methods -->
    <section class="sponsor-section sponsor-section-alt">
      <div class="sponsor-section-inner-donate">
        <div class="section-header">
        ...
        <div class="donate-grid">
          ...
          <div class="donate-card donate-hover">
            <div class="donate-header paddle-bg">
              <svg class="donate-header-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                ...
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="1.8"
                  d="M3 9h18M7 14.5h3.5"
                />
              </svg>
            </div>
            <div class="donate-body">
              <h3>Paddle</h3>
              <p>Credit Card / Local Payments</p>
              <div class="paddle-amount-wrap">
                <span class="paddle-amount">$10</span>
                <span class="paddle-amount-label">One-time support</span>
              </div>
              <button
                type="button"
              ...
              >
                {{ paddleLoading ? 'Opening Checkout...' : 'Support with Paddle' }}
          ...
          <div class="donate-card donate-hover">
            <div class="donate-header wechat-bg">
              <svg class="donate-header-icon" viewBox="0 0 1025 1024" fill="currentColor">
                <path
      ...
      <div class="sponsor-section-inner">
        ...
        <div class="roadmap-card">
          ...
          <div class="roadmap-footer">
            <a
              href="https://github.com/xpf0000/FlyEnv/discussions"
              target="_blank"
              rel="noopener noreferrer"
              class="roadmap-link no-underline"
            >
              Have a feature idea? Join the discussion on GitHub
              <svg class="roadmap-link-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  stroke-width="2"
          ...
          <div class="thanks-body">
            ...
            <p class="thanks-desc"
              ...
              <a
                ...
                class="no-underline"
                >FastAdmin</a
              >, for sponsoring the <strong>flyenv.com</strong> domain.</p
            >
          </div>
      ...
      <div class="sponsor-section-inner-medium">
        <div class="cta-banner">
          ...
          <div class="cta-content">
            ...
            <p
              >FlyEnv is powered by its community. Whether you donate, contribute code, or simply
              spread the word — you're helping make local development better for everyone.</p
            >
            <div class="cta-buttons">
              ...
              >
                <svg class="cta-btn-icon" viewBox="0 0 24 24" fill="currentColor">
                  <path
...
<script setup lang="ts">
  ...
  const { paddleLoading, paddleError, openPaddleCheckout } = usePaddleCheckout({
    source: 'sponsor_page',
    errorMessage: 'Paddle checkout is temporarily unavailable. Please try another method.'
  })
</script>
