    ...
    <section class="sponsor-hero-section">
      <div class="sponsor-hero-inner">
        ...
        <p class="sponsor-hero-desc">
          FlyEnv 是一款独立构建的开源环境管理工具，支持 macOS、Windows 和
          Linux。您的支持让它保持免费并持续改进。
        </p>
      </div>
    </section>
          ...
          <div class="donate-card donate-hover">
            ...
            <div class="donate-body">
              ...
              <div class="paddle-amount-wrap">
                ...
                <span class="paddle-amount-label">一次性支持</span>
              </div>
              <button
                type="button"
              ...
              >
                {{ paddleLoading ? '正在打开付款...' : '使用 Paddle 支持' }}
          ...
          <div class="thanks-body">
            ...
            <p class="thanks-desc"
              ><a
                ...
                >FastAdmin</a
              >
              创始人，赞助了 <strong>flyenv.com</strong> 域名。</p
            >
          </div>
      ...
      <div class="sponsor-section-inner-medium">
        <div class="cta-banner">
          ...
          <div class="cta-content">
            ...
            <p
              >FlyEnv 由社区驱动。无论您捐赠、贡献代码，还是简单地传播口碑 ——
...
<script setup lang="ts">
  ...
  const { paddleLoading, paddleError, openPaddleCheckout } = usePaddleCheckout({
    source: 'zh_sponsor_page',
    errorMessage: 'Paddle 付款暂时不可用，请尝试其他支持方式。'
  })
</script>
