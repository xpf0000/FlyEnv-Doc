    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 w-full">
        <div class="text-center bg-white dark:bg-gray-800 px-6 py-8 rounded-lg shadow-lg">
          ...
          <p class="mb-2 text-sm">Debian/Ubuntu</p>
          <p class="mb-7 text-sm">x64 .deb</p>
          <a
            :href="urls.linuxDebX64"
            :download="name(urls.linuxDebX64)"
            class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"
            >{{ down }}</a
          >
        </div>
        <div class="text-center bg-white dark:bg-gray-800 px-6 py-8 rounded-lg shadow-lg">
          ...
          <p class="mb-2 text-sm">Debian/Ubuntu</p>
          <p class="mb-7 text-sm">arm64 .deb</p>
          <a
            :href="urls.linuxDebArm64"
            :download="name(urls.linuxDebArm64)"
            class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"
            >{{ down }}</a
          >
        </div>
        <div class="text-center bg-white dark:bg-gray-800 px-6 py-8 rounded-lg shadow-lg">
          ...
          <p class="mb-2 text-sm">Red Hat/Fedora/SUSE/CentOS</p>
          <p class="mb-7 text-sm">x64 .rpm</p>
          <a
            :href="urls.linuxRpmX64"
            :download="name(urls.linuxRpmX64)"
            class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"
            >{{ down }}</a
          >
        </div>
        <div class="text-center bg-white dark:bg-gray-800 px-6 py-8 rounded-lg shadow-lg">
          ...
          <p class="mb-2 text-sm">Red Hat/Fedora/SUSE/CentOS</p>
          <p class="mb-7 text-sm">arm64 .rpm</p>
          <a
            :href="urls.linuxRpmArm64"
            :download="name(urls.linuxRpmArm64)"
            class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700"
            >{{ down }}</a
          >
        </div>
...
<script lang="ts" setup>
  ...
  const urls = {
    win: 'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-Setup-4.15.0.exe',
    winPortable:
      'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-Portable-4.15.0.exe',
    macX86: 'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0.dmg',
    macArm: 'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0-arm64.dmg',
    linuxDebX64:
      'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0-x64.deb',
    linuxDebArm64:
      'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0-arm64.deb',
    linuxRpmX64:
      'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0-x64.rpm',
    linuxRpmArm64:
      'https://github.com/xpf0000/FlyEnv/releases/download/v4.15.0/FlyEnv-4.15.0-arm64.rpm'
  }
