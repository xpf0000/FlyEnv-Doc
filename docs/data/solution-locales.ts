...
export const solutionContentByLocale: Record<SolutionLocale, LocalizedSolutionMap> = {
  ...
  es: {
    laravel: { description: 'Framework PHP moderno para aplicaciones web expresivas.', summary: 'Los proyectos Laravel suelen combinar PHP, una base de datos, un servidor web y servicios opcionales como Redis. FlyEnv gestiona ese entorno local alrededor de la aplicación en Windows, macOS y Linux.', overview: 'Laravel es un framework PHP para crear aplicaciones web y API.' },
