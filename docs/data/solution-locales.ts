...
> = {
  ...
  es: {
    frameworks: 'Frameworks',
    cms: 'CMS y sitios web',
    ecommerce: 'Comercio electrónico',
    erp: 'ERP y aplicaciones empresariales',
    crm: 'CRM',
...
export const solutionContentByLocale: Record<SolutionLocale, LocalizedSolutionMap> = {
  en: {},
  zh: {
    laravel: { description: '用于构建 Web 应用和 API 的现代 PHP 框架。', summary: '使用 FlyEnv 在 Windows、macOS 和 Linux 上，通过 PHP、Composer、MySQL 或 PostgreSQL、Redis、Nginx、本地域名和 HTTPS 构建并管理 Laravel 本地开发环境。', overview: 'Laravel 是用于构建 Web 应用和 API 的 PHP 框架。' },
  ...
  id: {
    laravel: { description: 'Framework PHP modern untuk aplikasi web dan API.', summary: 'Bangun dan kelola lingkungan pengembangan Laravel lokal dengan PHP, Composer, MySQL atau PostgreSQL, Redis, Nginx, domain lokal, dan HTTPS menggunakan FlyEnv di Windows, macOS, dan Linux.', overview: 'Laravel adalah framework PHP untuk membangun aplikasi web dan API.' },
  ...
  es: {
    laravel: { description: 'Framework PHP moderno para aplicaciones web expresivas.', summary: 'Construye y gestiona un entorno de desarrollo local de Laravel con PHP, Composer, MySQL o PostgreSQL, Redis, Nginx, dominios locales y HTTPS con FlyEnv en Windows, macOS y Linux.', overview: 'Laravel es un framework PHP para crear aplicaciones web y API.' },
    django: { description: 'Framework Python de alto nivel para sitios seguros basados en bases de datos.', summary: 'Los proyectos Django suelen combinar Python con una base de datos y, según la aplicación, servicios como Redis y un proxy inverso. FlyEnv mantiene esos servicios locales gestionables alrededor del proyecto Django.', overview: 'Django es un framework web Python de alto nivel para aplicaciones web basadas en bases de datos.' },
    fastapi: { description: 'Framework Python moderno para crear API web rápidas.', summary: 'Las aplicaciones FastAPI suelen necesitar un runtime de Python además de la base de datos y los servicios auxiliares elegidos por la API. FlyEnv ayuda a gestionar esos servicios alrededor de un proyecto FastAPI local.', overview: 'FastAPI es un framework Python para crear API con type hints modernos.' },
    'spring-boot': { description: 'Framework Java para servicios web listos para producción.', summary: 'Los servicios Spring Boot suelen ejecutarse con un runtime de Java y pueden conectarse a una base de datos, Redis y un proxy inverso local. FlyEnv gestiona esos servicios del entorno junto a la aplicación.', overview: 'Spring Boot es un framework Java para crear servicios independientes y listos para producción.' },
    wordpress: { description: 'El CMS más popular del mundo para crear sitios web.', summary: 'WordPress suele ejecutarse con PHP, MySQL o MariaDB y un servidor web local. FlyEnv gestiona ese conocido entorno de CMS y servicios opcionales como Redis alrededor de cada sitio.', overview: 'WordPress es un sistema de gestión de contenidos de código abierto para crear sitios web.' },
    drupal: { description: 'CMS flexible de código abierto para experiencias digitales ricas en contenido.', summary: 'Los proyectos Drupal suelen combinar PHP con una base de datos, un servidor web y herramientas de dependencias específicas del proyecto. FlyEnv gestiona los runtimes y servicios locales alrededor de esa instalación de Drupal.', overview: 'Drupal es un CMS de código abierto para sitios web ricos en contenido y altamente configurables.' },
    ghost: { description: 'Plataforma de publicación independiente para creadores y equipos.', summary: 'Los sitios de publicación con Ghost suelen usar Node.js y pueden usar MySQL con un servidor web o un proxy inverso. FlyEnv gestiona el runtime local y los servicios auxiliares alrededor de un proyecto Ghost.', overview: 'Ghost es una plataforma de publicación de código abierto para creadores y equipos.' },
    nextcloud: { description: 'Plataforma autoalojada para compartir archivos y colaborar.', summary: 'Las instalaciones de Nextcloud suelen usar PHP, una base de datos, un servidor web y Redis opcional. FlyEnv ayuda a mantener coordinados esos servicios locales de colaboración alrededor del proyecto Nextcloud.', overview: 'Nextcloud es una plataforma autoalojada para compartir archivos y colaborar.' },
    magento: { description: 'Potente plataforma de comercio electrónico para tiendas en línea.', summary: 'Los proyectos Magento suelen combinar PHP, una base de datos, búsqueda, caché y un servidor web. FlyEnv ayuda a gestionar ese stack local sensible a las versiones alrededor del proyecto Magento.', overview: 'Magento Open Source es una plataforma de comercio electrónico de código abierto para tiendas en línea y aplicaciones de comercio.' },
    prestashop: { description: 'Plataforma de comercio electrónico de código abierto para comerciantes en línea.', summary: 'Los proyectos PrestaShop suelen usar PHP, MySQL o MariaDB y un servidor web local. FlyEnv gestiona esos servicios alrededor de una tienda en línea y las herramientas opcionales de desarrollo de temas.', overview: 'PrestaShop es una plataforma de comercio electrónico de código abierto para comerciantes en línea.' },
    opencart: { description: 'Plataforma sencilla de tienda en línea para vender productos.', summary: 'Las tiendas OpenCart suelen necesitar PHP, una base de datos compatible con MySQL y un servidor web local. FlyEnv mantiene ese entorno de comercio organizado alrededor del proyecto.', overview: 'OpenCart es una plataforma de comercio electrónico de código abierto para crear tiendas en línea.' },
    erpnext: { description: 'ERP de código abierto para gestionar las operaciones empresariales diarias.', summary: 'Los entornos ERPNext pueden combinar Python, MariaDB, Redis, un servidor web y herramientas de frontend. FlyEnv ayuda a gestionar estos servicios locales relacionados alrededor del proyecto ERPNext.', overview: 'ERPNext es un ERP de código abierto para gestionar las operaciones empresariales.' },
    odoo: { description: 'Suite de aplicaciones empresariales de código abierto.', summary: 'Los proyectos Odoo suelen usar Python y PostgreSQL, con un servidor web o un proxy cuando se necesita un dominio local. FlyEnv ayuda a gestionar estos servicios del entorno local alrededor de la aplicación.', overview: 'Odoo es una suite de aplicaciones empresariales de código abierto.' },
    suitecrm: { description: 'Plataforma de gestión de relaciones con clientes de código abierto.', summary: 'Los proyectos SuiteCRM suelen usar PHP, una base de datos compatible con MySQL y un servidor web local. FlyEnv ayuda a mantener esos servicios del entorno CRM alineados con el proyecto.', overview: 'SuiteCRM es una plataforma de gestión de relaciones con clientes de código abierto.' },
    espocrm: { description: 'CRM flexible para equipos de ventas, marketing y soporte.', summary: 'EspoCRM suele ejecutarse con PHP, una base de datos compatible con MySQL y un servidor web. FlyEnv ayuda a gestionar ese entorno CRM local y cualquier servicio auxiliar específico del proyecto.', overview: 'EspoCRM es una plataforma CRM de código abierto para equipos de ventas, marketing y soporte.' },
    gitea: { description: 'Servicio Git autoalojado para equipos y desarrolladores individuales.', summary: 'Gitea puede usar una base de datos local y un proxy inverso o servidor web para el acceso desde el navegador. FlyEnv ayuda a gestionar esos servicios y las herramientas de Go cuando un proyecto compila Gitea desde el código fuente.', overview: 'Gitea es un servicio Git autoalojado de código abierto para equipos y desarrolladores individuales.' },
    strapi: { description: 'CMS headless de código abierto para API de contenido.', summary: 'Los proyectos Strapi suelen usar Node.js con una base de datos SQL y pueden añadir Redis o un proxy inverso. FlyEnv gestiona esos servicios locales alrededor del proyecto de CMS headless.', overview: 'Strapi es un CMS headless de código abierto para crear API de contenido.' },
    directus: { description: 'Plataforma de datos para convertir bases de datos SQL en API.', summary: 'Los proyectos Directus suelen ejecutarse con Node.js y una base de datos SQL, y pueden usar Redis o un proxy local. FlyEnv ayuda a gestionar los servicios que dan soporte a una plataforma de datos Directus local.', overview: 'Directus es una plataforma de datos que convierte bases de datos SQL en API y aplicaciones.' },
    matomo: { description: 'Plataforma de analítica web de código abierto con propiedad de los datos.', summary: 'Matomo suele usar PHP, una base de datos compatible con MySQL y un servidor web para el desarrollo local de analítica. FlyEnv gestiona esos servicios locales alrededor del proyecto Matomo.', overview: 'Matomo es una plataforma de analítica web de código abierto centrada en la propiedad de los datos.' },
    metabase: { description: 'Herramienta de inteligencia de negocio y exploración de datos de código abierto.', summary: 'Metabase usa un runtime de Java y una base de datos para los metadatos de la aplicación, con un proxy cuando resulta útil un dominio local. FlyEnv gestiona esos servicios del entorno local alrededor de Metabase.', overview: 'Metabase es una herramienta de inteligencia de negocio y exploración de datos de código abierto.' },
    nextjs: { description: 'Framework React para aplicaciones web full-stack y renderizado en el servidor.', summary: 'Los proyectos Next.js suelen combinar Node.js con una base de datos, Redis opcional y un proxy inverso para el desarrollo full-stack local. FlyEnv mantiene esos servicios disponibles por proyecto.', overview: 'Next.js es un framework React para aplicaciones web full-stack y renderizado en el servidor.' },
    nestjs: { description: 'Framework TypeScript para aplicaciones del lado del servidor estructuradas y escalables.', summary: 'Los servicios NestJS suelen usar Node.js, una base de datos, Redis y un proxy inverso. FlyEnv gestiona esas dependencias locales alrededor de un backend TypeScript.', overview: 'NestJS es un framework TypeScript para aplicaciones del lado del servidor estructuradas y escalables.' },
    nuxt: { description: 'Framework Vue para aplicaciones web full-stack y renderizado en el servidor.', summary: 'Las aplicaciones Nuxt se ejecutan con Node.js y pueden usar una base de datos o un proxy inverso para el desarrollo full-stack local. FlyEnv gestiona el runtime y los servicios seleccionados.', overview: 'Nuxt es un framework Vue para aplicaciones web full-stack y renderizado en el servidor.' },
    express: { description: 'Framework Node.js minimalista para aplicaciones web y API.', summary: 'Las aplicaciones Express usan Node.js con la base de datos, la caché y el proxy elegidos por el proyecto. FlyEnv ayuda a mantener organizado este stack de API local flexible.', overview: 'Express es un framework Node.js minimalista para aplicaciones web y API.' },
    'react-vite': { description: 'Desarrollo rápido de aplicaciones React con la herramienta de build Vite.', summary: 'Los proyectos React y Vite necesitan un runtime de Node.js para el desarrollo y las builds, con un servidor web local opcional para vistas previas similares a producción. FlyEnv gestiona ese entorno por proyecto.', overview: 'React + Vite es un flujo de trabajo rápido para crear aplicaciones React modernas.' },
    'vue-vite': { description: 'Desarrollo de aplicaciones Vue modernas con la herramienta de build Vite.', summary: 'Los proyectos Vue 3 y Vite usan Node.js para su servidor de desarrollo local y sus herramientas de build. FlyEnv gestiona el runtime y el servidor web local opcional.', overview: 'Vue 3 + Vite es un flujo de trabajo moderno para crear aplicaciones Vue.' },
    sveltekit: { description: 'Framework Svelte para aplicaciones web full-stack rápidas.', summary: 'Las aplicaciones SvelteKit usan Node.js con servicios de datos opcionales y un proxy inverso. FlyEnv mantiene el entorno full-stack local manejable por proyecto.', overview: 'SvelteKit es un framework para crear aplicaciones Svelte full-stack rápidas.' },
    adonisjs: { description: 'Framework Node.js TypeScript-first para aplicaciones web full-stack.', summary: 'Las aplicaciones AdonisJS combinan un runtime de Node.js con TypeScript, una base de datos, Redis opcional y un servidor web local. FlyEnv coordina esos servicios.', overview: 'AdonisJS es un framework Node.js TypeScript-first para aplicaciones web full-stack.' },
    hono: { description: 'Framework web pequeño y rápido para runtimes de JavaScript y TypeScript.', summary: 'Las API de Hono pueden ejecutarse con Node.js o Bun junto a la base de datos y el proxy seleccionados por el proyecto. FlyEnv gestiona esos entornos de API locales ligeros.', overview: 'Hono es un framework web pequeño y rápido para runtimes de JavaScript y TypeScript.' },
    payload: { description: 'CMS headless TypeScript y framework de aplicaciones.', summary: 'Los proyectos Payload CMS usan Node.js, MongoDB u otra base de datos configurada, Redis opcional y un proxy local. FlyEnv gestiona los servicios locales que los rodean.', overview: 'Payload es un CMS headless TypeScript y un framework de aplicaciones.' },
    medusa: { description: 'Plataforma de comercio componible construida con Node.js y TypeScript.', summary: 'Los proyectos Medusa usan Node.js, PostgreSQL, Redis y, a menudo, un proxy local. FlyEnv mantiene organizado este stack de comercio TypeScript para el desarrollo local.', overview: 'Medusa es una plataforma de comercio componible construida con Node.js y TypeScript.' },
    'node-red': { description: 'Herramienta de programación basada en flujos para integraciones orientadas a eventos y automatización.', summary: 'Node-RED se ejecuta con Node.js y puede exponerse a través de un proxy local para integraciones y webhooks. FlyEnv gestiona el runtime y la configuración de acceso local.', overview: 'Node-RED es una herramienta de programación basada en flujos para integraciones orientadas a eventos y automatización.' },
    flask: { description: 'Framework Python ligero para aplicaciones web y API.', summary: 'Las aplicaciones Flask usan Python con la base de datos, Redis y el proxy inverso seleccionados por el proyecto. FlyEnv mantiene organizado ese stack web local ligero.', overview: 'Flask es un framework Python ligero para aplicaciones web y API.' },
    'apache-superset': { description: 'Plataforma de exploración de datos e inteligencia de negocio de código abierto.', summary: 'Apache Superset usa Python, una base de datos de metadatos, Redis y un proxy inverso. FlyEnv ayuda a gestionar juntos estos servicios locales de analítica.', overview: 'Apache Superset es una plataforma de exploración de datos e inteligencia de negocio de código abierto.' },
    quarkus: { description: 'Framework Java optimizado para aplicaciones y API cloud-native.', summary: 'Los servicios Quarkus se ejecutan con Java y bases de datos específicas del proyecto, Redis y configuración de proxy local. FlyEnv gestiona esas dependencias alrededor del servicio.', overview: 'Quarkus es un framework Java optimizado para aplicaciones y API cloud-native.' },
    keycloak: { description: 'Gestión de identidad y acceso de código abierto para aplicaciones y API.', summary: 'Keycloak usa Java y una base de datos, con un proxy local al probar la autenticación basada en el navegador. FlyEnv gestiona esas dependencias locales del servicio de identidad.', overview: 'Keycloak es una plataforma de gestión de identidad y acceso de código abierto para aplicaciones y API.' },
    gin: { description: 'Framework Go de alto rendimiento para servicios web y API.', summary: 'Los servicios Gin usan Go con la base de datos, Redis y el proxy seleccionados por cada proyecto. FlyEnv ayuda a mantener este stack de API ligero listo en local.', overview: 'Gin es un framework Go de alto rendimiento para servicios web y API.' },
    pocketbase: { description: 'Plataforma backend con base de datos integrada, API, autenticación y almacenamiento de archivos.', summary: 'PocketBase es un backend compacto en Go con una base de datos SQLite integrada y puede exponerse a través de un proxy local. FlyEnv gestiona su runtime y su URL local.', overview: 'PocketBase es una plataforma backend con base de datos integrada, API, autenticación y almacenamiento de archivos.' },
    'ruby-on-rails': { description: 'Framework Ruby full-stack para aplicaciones web basadas en bases de datos.', summary: 'Las aplicaciones Rails suelen usar Ruby con PostgreSQL, Redis y un proxy inverso. FlyEnv mantiene organizadas estas dependencias full-stack locales alrededor de cada proyecto.', overview: 'Ruby on Rails es un framework Ruby full-stack para aplicaciones web basadas en bases de datos.' },
    'aspnet-core': { description: 'Framework .NET multiplataforma para aplicaciones web y API modernas.', summary: 'Los proyectos ASP.NET Core usan el runtime de .NET con servicios de datos específicos del proyecto y un proxy inverso local. FlyEnv coordina este stack web local multiplataforma.', overview: 'ASP.NET Core es un framework .NET multiplataforma para aplicaciones web y API modernas.' }
  }
}
