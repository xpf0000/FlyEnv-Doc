...
| 模块分类 | 支持的软件                                                                                                                                                                                                                                                                                                                                                     |
| --- |-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AI 编程与 MCP | [FlyEnv MCP Server](https://www.bilibili.com/video/BV1AyM761EpZ/)、Claude Code、Codex、OpenCode、Kimi、Antigravity CLI、GitHub Copilot CLI                                                                                                                                                                                                                      |
| AI 集成与自动化 | Hermes Agent、[OpenClaw](https://www.bilibili.com/video/BV1ciwMzUEGH/)、[n8n](https://www.bilibili.com/video/BV1qGXFBfE7U/)、[Ollama](https://www.bilibili.com/video/BV13UZcYGEhu/)、[CLIProxyAPI](https://www.bilibili.com/video/BV1biGG6nEYz/)                                                                                                              |
| 容器 | Podman                                                                                                                                                                                                                                                                                                                                                    |
| 网络隧道 | Cloudflared、Cloudflare Tunnel                                                                                                                                                                                                                                                                                                                             |
| Web 服务器 | FrankenPHP、[Apache](https://www.bilibili.com/video/BV1wqZ7BNErL/)、[Nginx](https://www.bilibili.com/video/BV1jKZ4BjEgk/)、[Caddy](https://www.bilibili.com/video/BV129uF6BExw/)、Tomcat                                                                                                                                                                      |
| 数据库 | [MySQL](https://www.bilibili.com/video/BV1vuZ4B5EAg/)、[MariaDB](https://www.bilibili.com/video/BV1NfEx6eE3V/)、[PostgreSQL](https://www.bilibili.com/video/BV19oE36BELa/)、[MongoDB](https://www.bilibili.com/video/BV182E26AELB/)、[Qdrant](https://www.bilibili.com/video/BV16Q3P6VEPA/)、[ClickHouse](https://www.bilibili.com/video/BV1S43w6QEvS/), Neo4j |
| 邮件服务器 | [Mailpit](https://www.bilibili.com/video/BV1CxEz6YEgx/)                                                                                                                                                                                                                                                                                                   |
| 编程语言与运行时 | .NET、Flutter、[PHP](https://www.bilibili.com/video/BV1r6Z7BwE8p/)、Composer、PHP-CLI、PHP-FPM、RoadRunner、Swoole CLI、Go、[Node.js](https://www.bilibili.com/video/BV1pzEs6tE2X/)、[Python](https://www.bilibili.com/video/BV1hvZxBBEJk/)、Java、Maven、Gradle、SDKMAN、Erlang、Ruby、Rust、Rustup、[Bun](https://www.bilibili.com/video/BV1GtGG6dE6y/)、Deno、Zig           |
| 缓存与消息队列 | [Redis](https://www.bilibili.com/video/BV1YaZxBzENJ/)、Memcached、[RabbitMQ](https://www.bilibili.com/video/BV1XiMZ6GEdw/)                                                                                                                                                                                                                                  |
| 服务治理 | [Consul](https://www.bilibili.com/video/BV1vNGV68EF4/)、[Etcd](https://www.bilibili.com/video/BV1eKGV6fEB5/)、[R-Nacos](https://www.bilibili.com/video/BV1XuGV6oECA/)、[Temporal](https://www.bilibili.com/video/BV1TD3c67Eei/)、[Temporal CLI](https://www.bilibili.com/video/BV1Xc3v6UEEW/)                                                                 |
...
| 自动化与调度 | Cron Jobs                                                                                                                                                                                                                                                                                                                                                 |
| 实用工具 | Git、MkCert、DNS Server、FTP Server、Static HTTP Server、[Numa](https://www.bilibili.com/video/BV1SeGG6DEHS/)                                                                                                                                                                                                                                                  |
...
本视频采用英文旁白和英文字幕，集中演示 FlyEnv 的核心本地开发流程：按需选择模块、安装和切换版本、管理服务、创建可复用启动组、配置本地站点，以及使用内置开发工具。

<iframe style="width: 100%; aspect-ratio: 16 / 9;" src="//player.bilibili.com/player.html?isOutside=true&aid=116935433914788&bvid=BV1eCNR6FE2k&cid=40044921688&p=1" title="FlyEnv 功能总览：无需 Docker 的原生本地开发环境" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"></iframe>

关于 AI 编程 CLI 和 MCP 功能，请继续阅读 [FlyEnv AI 工作区与 MCP 指南](/zh/guide/ai-coding-workspace-mcp)。
